...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Highly recommend. These guys diagnosed and fixed the problems with my BMW at a decent price. Very knowledgeable on BMW's. Great, after service. Timing chain, injectors, etc.all sorted. Thanks.👍",
    name: "Anil",
  },
